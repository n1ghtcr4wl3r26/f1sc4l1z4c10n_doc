DROP PACKAGE FISCALIZACION.PKG_GENERAL;

CREATE OR REPLACE PACKAGE FISCALIZACION.pkg_general
...
END;
/
DROP PACKAGE BODY FISCALIZACION.PKG_GENERAL;

CREATE OR REPLACE PACKAGE BODY FISCALIZACION.pkg_general
/* Formatted on 15-ene.-2017 20:43:30 (QP5 v5.126) */
AS
    FUNCTION devuelve_fecha
        RETURN VARCHAR2
    IS
