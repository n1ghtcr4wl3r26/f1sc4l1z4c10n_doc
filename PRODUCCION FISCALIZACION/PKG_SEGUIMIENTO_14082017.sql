DROP PACKAGE FISCALIZACION.PKG_SEGUIMIENTO;

CREATE OR REPLACE PACKAGE FISCALIZACION.pkg_seguimiento
...
END;
/
DROP PACKAGE BODY FISCALIZACION.PKG_SEGUIMIENTO;

CREATE OR REPLACE PACKAGE BODY FISCALIZACION.pkg_seguimiento
/* Formatted on 3-ene.-2017 8:30:29 (QP5 v5.126) */
IS
    FUNCTION devuelve_fecha
        RETURN VARCHAR2
    IS
